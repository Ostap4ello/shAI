...
The first prototype is a simple proof-of-concept implementation of the idea. It
uses a local LLM (Ollama) to distinguish between shell commands and natural
language input. If the input is a shell command, it would execute it directly;
if it's natural language, it would respond with an answer or suggestion.\\
...
(whis will be visible when using TUI applications inside the wrapper).\\
...
\subsubsection{Component 2. Task splitter}

\subsubsection{Component 3. Information retriever}
