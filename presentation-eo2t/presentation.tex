...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{Broader Task Support}
        \item \textbf{Application to Other Domains}
        \item \textbf{User Interface Improvements}
        \item \textbf{Experimenting with top\_k and section size for passage-level retrieval}
        \item \textbf{Software Optimization/Refactoring}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item \textbf{Caching and Context Management}
        \item \textbf{Exploring Different Harnessing Approaches}
        \item \textbf{\textsl{Multi-modal Capabilities}}
    \end{itemize}
\end{frame}
