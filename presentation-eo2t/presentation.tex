...
% TODO: 
% - split design and evaluation
% - more detail and concreteness to BT tasks/rationale
...
\begin{frame}
    ...
    \begin{itemize}
        \item Introduction
            \begin{itemize}
                \item Thesis topic and rationale
                \item Theory
            \end{itemize}
        \item Thesis work
             \begin{itemize}
...
\begin{frame}
    \frametitle{Introduction: Thesis topic and rationale}
    \begin{itemize}
        \item \textbf{Objective}: test the use of local LLMs in the context of a
            terminal assistant
        \item \textbf{Limitations}: usage of local LLMs under 2B parameters
            (suitable for devices with 8GB RAM)
    \vspace{0.5cm} \small
        \item \textbf{Rationale}: offline execution, independence from remote
            servers, network access, privacy
        \item \textbf{Work overview}: this work has tested and evaluated
            different approaches for usage of local LLMs in the context of a
            terminal assistant. It also provides a reference implementation of
            such an assistant, available on GitHub (\texttt{Ostap4ello/shAI-l})
            and university archive along with the testing data and results.
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item \textbf{Outcomes}: for a shell wrapper, the models have shown the
            ...
            \begin{itemize}
                \item Low accuracy
                \item Unacceptable latency-accuracy profile for interactive use
...
\begin{table}[h]
  \centering
  \scriptsize
  \caption{Overview of performances across retrieval approaches on \texttt{sample-100}.}
...
\end{table}
    \begin{itemize}
        \item \textbf{Outcomes}:
            ...
            \end{itemize}
            % TODO: note on Index Build latency great range
    \end{itemize}
\end{frame}
...
% TODO: merge slides 14,17
% TODO: merge slides 15,16
