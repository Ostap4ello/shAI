...
\begin{frame}
    ...
    \begin{enumerate}
        \item How would you evaluate quality of answer in End-to-End testing?\\
            \textsl{\textbf{For such case, it is commonly used such tests like
            Groundedness/Correctness/Relevance test, often employing LLM-as-a-Judge
        ...
        \item Author says: ``The models struggle with edge cases and ambiguous
            ...
            \begin{itemize}
                \item a) How can multiple LLM calls help with model struggling
                    ...
                    \textsl{\textbf{By this statement, initially stayed 2 ideas:
                    (1) inaccurate classification will naturally make user
                    interrupt the execution and prompt the question again until
                    it is classified correctly, or (2) using various techniques
                    to try to recognize such ambiguous inputs and pass them to
                    bigger model or prompt user.}}
                \item b) How can we use hardcoded heuristics to improve agent’s
                    performance?\\
                    \textsl{\textbf{Higher accuracy is to be achieved by
                    conducting extended syntax and PATH
                    checks and pass this as additional information to
                    classifier or execute this directly.}}
            \end{itemize}
    \end{enumerate}
\end{frame}
