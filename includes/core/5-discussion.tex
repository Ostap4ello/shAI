...
help on user document datatbase without network dependency, or privacy concerns.
...
Future work arount this topic can explore various avenues to build on the
...
define further research directionsin the field:
\begin{itemize}
