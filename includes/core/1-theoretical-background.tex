...
the following sections\cite{ttyman,linfo_terminal}.\\
...
execute commands and other \gls{cli} utilities\cite{ttyman,linfo_terminal}.
...
characters)\cite{ttyman,linfo_terminal}.\\
