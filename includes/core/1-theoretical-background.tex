...
\paragraph{Terminal}
(later reffered to as \textbf{Hardware terminal})
...
(later reffered to as \textbf{Terminal})
...
from simple \gls{cli} utilities to complex \gls{tui} programs
\cite{man_man,linfo_terminal}.\\
...
examples of shells and \gls{cli} utilities are mentioned in Table\
\ref{t:utils}.\\
...
\subsection{Document Representation For Retrieval}
