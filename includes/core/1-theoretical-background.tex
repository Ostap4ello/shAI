...
Examples of vector databases include \gls{faiss}\cite{faiss2026},
\gls{annoy}\cite{annoy2026}, and Milvus\cite{milvus2026}.
...
\subsubsection{Common RAG Testing Techniques}\label{sec:rag-eval}
