...
\paragraph{Terminal}
(later referred to as \textbf{Hardware terminal})
...
and solve complex tasks (via text
...
pseudocode in Listing~\ref{lst:agent}.

% TODO: to algorithmic/algpseudocode/algpseudocodex
\begin{lstlisting}[,
...
We can define the workflow of \gls{rag} as follows as pseudocode in
Listing~\ref{lst:rag}.
...
% TODO: to attachments as not relevant info
